  ...
  const ErrorSquare = createMeisterIcons("error-square", [["path",{"fill":"currentColor","d":"M15 20.25c2.886 0 5.25-2.364 5.25-5.25V9c0-2.886-2.364-5.25-5.25-5.25H9C6.114 3.75 3.75 6.114 3.75 9v6c0 2.886 2.364 5.25 5.25 5.25h6ZM21.75 15c0 3.714-3.036 6.75-6.75 6.75H9c-3.714 0-6.75-3.036-6.75-6.75V9c0-3.714 3.036-6.75 6.75-6.75h6c3.714 0 6.75 3.036 6.75 6.75v6Z","key":"b062e336a560d71be8b770c94dbd003aaf3bcfd7"}],["path",{"fill":"currentColor","d":"M12.2 14c-.4 0-.8-.3-.8-.8v-6c0-.4.3-.7.8-.7s.8.3.8.8v6c-.1.4-.4.7-.8.7Zm0 3c-.1 0-.2 0-.3-.1-.1 0-.2-.1-.2-.2s-.2-.1-.2-.2c-.1-.1-.1-.2-.1-.2 0-.1 0-.2.1-.3 0-.1.1-.2.2-.2.1-.1.2-.1.2-.2.3-.1.6-.1.8.2l.2.2c0 .1.1.2.1.3 0 .2-.1.4-.2.5-.3.1-.4.2-.6.2Z","key":"392cc7c8777dc6e77d008cbc15bbdc4d9981d001"}]])
