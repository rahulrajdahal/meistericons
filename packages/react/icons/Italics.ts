  ...
  const Italics = createMeisterIcons("italics", [["path",{"fill":"currentColor","fill-rule":"evenodd","d":"M14.91 4.147a.75.75 0 0 1 .443.964l-5.3 14.3a.75.75 0 1 1-1.406-.522l5.3-14.3a.75.75 0 0 1 .964-.442Z","clip-rule":"evenodd"}],["path",{"fill":"currentColor","fill-rule":"evenodd","d":"M9.5 4.85a.75.75 0 0 1 .75-.75h8.7a.75.75 0 0 1 0 1.5h-8.7a.75.75 0 0 1-.75-.75Zm-5.2 14.3a.75.75 0 0 1 .75-.75h8.6a.75.75 0 1 1 0 1.5h-8.6a.75.75 0 0 1-.75-.75Z","clip-rule":"evenodd"}]])
