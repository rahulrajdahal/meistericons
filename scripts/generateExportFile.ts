...
export default (inputEntry:any,outputDir:any, iconNodes:any,iconFileExt='')=>{
    ...
    icons.forEach(iconName=>{
        ...
        const importString = `export {default as ${componentName}} from './${toPascalCase(iconName)}${iconFileExt}';\n`;
