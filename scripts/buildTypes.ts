...
import { appendFile, getCurrentDirPath, readSvgDir, toPascalCase, writeFile } from './helpers.js';
...
svgFiles.forEach((svgFile) => {
  ...
  appendFile(`export declare const ${namePascal}: IconNode;\n`, typesFileName, targetDir);
});

console.log(`Generated ${typesFileName} file with`, svgFiles.length, 'icons');